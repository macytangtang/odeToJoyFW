<template>
    <div>
        <h1 class="wrap-title mar-bottom15">服务列表 <el-button type="primary" @click="addEditorData(0, 'add')" size="mini" class="bread-addbtn">新增服务或功能</el-button></h1>
        <el-row class="mar-bottom10">
            <el-col :span="24" class="el-item pdd-10">
                <el-table :data="moduleData.list" style="width: 100%">
                    ...
                    <el-table-column prop="title" label="服务或功能名称" width="150"></el-table-column>
...
export default {
    ...
    computed: {
        dialogTitle() { return this.marked === 'add' ? '新增服务或功能' : '编辑服务或功能' }
    },
    methods: {
        getModuleData() {
